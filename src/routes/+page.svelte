...
{:else if data.receipt && guestsProvided}
	<AssignItems receiptData={data.receipt} {peopleSet} {peopleColors} itemsAssigned={showResults} />
{:else if data.receipt && guestsProvided && peopleSet.size < guestCount - 1}
	<div class="mx-auto mt-8 max-w-xl p-4">
		...
		<p class="mb-4 text-gray-600">Please make sure all guests have been added before proceeding.</p>
	</div>
